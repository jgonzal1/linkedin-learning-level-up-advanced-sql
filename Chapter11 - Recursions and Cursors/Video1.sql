...
·     ____                            _           
·    / __ \___  _______  ____________(_)   _____  
·   / /_/ / _ \/ ___/ / / / ___/ ___/ / | / / _ \ 
·  / _, _/  __/ /__/ /_/ / /  (__  ) /| |/ /  __/ 
· /_/ |_|\___/\___/\__,_/_/  /____/_/ |___/\___/  
·            _        ______________  __          
·           | |     / /  _/_   __/ / / /          
·           | | /| / // /  / /  / /_/ /           
·           | |/ |/ // /  / /  / __  /            
...
FROM
  days_of_2019
ORDER BY
  DAY ASC -- OPTION (MAXRECURSION 365)
;
...
-- Crawl the web starting with URL U2
WITH
  Crawler (From_URL, To_URL, Level) AS (
    SELECT
      CAST('i' AS CHAR(3))
