...
SELECT cus.firstName,
    ...
    sls.soldDate
FROM customer cus
    INNER JOIN sales sls ON cus.customerId = sls.customerId
UNION
...
SELECT cus.firstName,
    ...
    sls.soldDate
FROM customer cus
    LEFT JOIN sales sls ON cus.customerId = sls.customerId
...
SELECT cus.firstName,
    ...
    sls.soldDate
FROM sales sls
    LEFT JOIN customer cus ON cus.customerId = sls.customerId
