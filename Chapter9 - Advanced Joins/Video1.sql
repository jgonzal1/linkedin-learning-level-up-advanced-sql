...
· DBFiddle UK SQL Server                 
· https://dbfiddle.uk/?rdbms=sqlserver_2019&fiddle=6900b64c2b229b09a679d00a6a2a982b&hide=3
·       _____      ______                   __   _   __                
·      / ___/___  / / __/  ____ _____  ____/ /  / | / /___  ____       
·      \__ \/ _ \/ / /_   / __ `/ __ \/ __  /  /  |/ / __ \/ __ \      
·     ___/ /  __/ / __/  / /_/ / / / / /_/ /  / /|  / /_/ / / / /      
·    /____/\___/_/_/     \__,_/_/ /_/\__,_/  /_/ |_/\____/_/ /_/       
·                                                                      
·    ______                  ___ __               __      _            
·   / ____/___ ___  ______ _/ (_) /___  __       / /___  (_)___  _____ 
·  / __/ / __ `/ / / / __ `/ / / __/ / / /  __  / / __ \/ / __ \/ ___/ 
· / /___/ /_/ / /_/ / /_/ / / / /_/ /_/ /  / /_/ / /_/ / / / / (__  )  
·/_____/\__, /\__,_/\__,_/_/_/\__/\__, /   \____/\____/_/_/ /_/____/   
·         /_/                    /____/                                
·*/
...
-- but we still get 2 rows for each adoption of
-- 2 animals on the same day.
SELECT
  A1.Adopter_Email
, A1.Adoption_Date
, A1.Name          AS First_Animal_Name
...
-- Now we get only 1 row for each 'double' adoption, but
-- we're not done yet.
SELECT
  A1.Adopter_Email
, A1.Adoption_Date
...
VALUES
  ('Duplicate', 'Dog', 'Black', NEWID (), NULL, 'M', '20171001', 'Solid', '20171101')
...
INSERT INTO
  Adoptions (Name, Species, Adopter_Email, Adoption_Date, Adoption_Fee)
VALUES
  ('Duplicate', 'Dog', 'alan.cook@hotmail.com', '20181201', 40)
...
FROM
  ...
  ) -- (Alvin Pillay 28/9/2020) The above code can be reduced
  -- to the following:
  ...
  --    )
  --
  -- This makes logical sense because we use (A1.Name > A2.Name)
  -- to get rid of the "repeating groups" and then for the cases where two animals 
  -- have the same name but different species
, -- we get rid of those with (A1.Name = A2.Name AND A1.Species > A2.Species).
ORDER BY
  A1.Adopter_Email
, A1.Adoption_Date
;
...
-- For the last predicate, we can't use 2 > as there is no guarantee
-- both name and species will be in that order.
